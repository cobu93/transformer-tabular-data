...
def get_mlp_simple_cv_stats(
    ...
    for arch_name, arch in architectures.items():
        ...
        with open(os.path.join(FS_EFFICENCY_CHECKPOINT_BASE_DIR, dataset, "mlp/full", "architectures.json"), "r") as f:
        ...
        base_checkpoint_dir = os.path.join(FS_EFFICENCY_CHECKPOINT_BASE_DIR, dataset, "mlp", "full", "none", "1.0", 
...
if __name__ == "__main__":
    ...
    models = [
        ...
        {
            "name": "mlp/simple",
            "cv_stats_fn": get_mlp_simple_cv_stats,
            "hp_space": {
                "hidden_units": [512],
                "num_hidden": [3, 6],
                "dropout": [0.2],
