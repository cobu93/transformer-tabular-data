...
class VolkertTransformerConfig(TransformerConfig):
    def __init__(self):
        pass
...
class VolkertSearchSpaceConfig(SearchSpaceConfig):
...
class VolkertDatasetConfig(DatasetConfig):

    def __init__(self):
        self.dir_name = "volkert/data"
        self.columns = None
