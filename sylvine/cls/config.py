...
class SylvineTransformerConfig(TransformerConfig):
    def __init__(self):
        pass
...
class SylvineSearchSpaceConfig(SearchSpaceConfig):
...
class SylvineDatasetConfig(DatasetConfig):

    def __init__(self):
        self.dir_name = "sylvine/data"
        self.columns = None
