...
class AustralianTransformerConfig(TransformerConfig):
    def __init__(self):
        pass
...
class AustralianSearchSpaceConfig(SearchSpaceConfig):
...
class AustralianDatasetConfig(DatasetConfig):

    def __init__(self):
        self.dir_name = "australian/data"
        self.columns = None
