...
class HelenaTransformerConfig(TransformerConfig):
    def __init__(self):
        pass
...
class HelenaSearchSpaceConfig(SearchSpaceConfig):
...
class HelenaDatasetConfig(DatasetConfig):

    def __init__(self):
        self.dir_name = "helena/data"
        self.columns = None
