...
class NomaoTransformerConfig(TransformerConfig):
    def __init__(self):
        pass
...
class NomaoSearchSpaceConfig(SearchSpaceConfig):
...
class NomaoDatasetConfig(DatasetConfig):

    def __init__(self):
        self.dir_name = "nomao/data"
        self.columns = None
